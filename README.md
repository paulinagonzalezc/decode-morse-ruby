...
```bash
git clone https://github.com/paulinagonzalezc/decode-morse-ruby
...
Feel free to check the [issues page](https://github.com/paulinagonzalezc/decode-morse-ruby/issues).
